...
final class RegistrationController: UIViewController {
    ...
    let firstNameField = TextField().buildTextField(with: "First Name", Resources.RColors.registrationFieldGrayColor.cgColor)
    var firstNameLabel = UILabel(Resources.RFonts.helveticaBold15,Resources.RColors.validationLabelColor, .left, "Required field")
    let secondNameField = TextField().buildTextField(with: "Second Name", Resources.RColors.registrationFieldGrayColor.cgColor)
    var secondNameLabel = UILabel(Resources.RFonts.helveticaBold15, Resources.RColors.validationLabelColor, .left, "Required field")
    let birthdayField = TextField().buildTextField(with: "Birthday", Resources.RColors.registrationFieldGrayColor.cgColor)
    ...
    let phoneField = TextField().buildTextField(with: "Phone", Resources.RColors.registrationFieldGrayColor.cgColor, false, .numberPad)
    var phoneLabel = UILabel(Resources.RFonts.helveticaBold15, Resources.RColors.validationLabelColor, .left, "Required field")
    let emailField = TextField().buildTextField(with: "Email", Resources.RColors.registrationFieldGrayColor.cgColor)
    var emailLabel = UILabel(Resources.RFonts.helveticaBold15, Resources.RColors.validationLabelColor, .left, "Required field")
    let passwordField = TextField().buildTextField(with: "Password", Resources.RColors.registrationFieldGrayColor.cgColor, true)
